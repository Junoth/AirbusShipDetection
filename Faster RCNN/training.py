...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.",default='E:\BU\EC 601 product Design\miniproject2\car_data\train')
...
parser.add_option("--input_weight_path", dest="input_weight_path",
                  ...
                  default='C:\\Users\lliqx\PycharmProjects\miniproject2\Car_SUV-model.h5')
...
if options.network == 'vggmodel':
    C.network = 'vggmodel'
    import vggmodel as nn
